<div class="bg-white rounded-lg shadow p-6">
    <h2 class="text-lg font-semibold text-gray-800 mb-4">Statistiche Generali</h2>
    ...
    @else
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4">
            ...
            <div class="flex flex-col items-center text-center p-4 bg-orange-50 rounded-lg">
                ...
                <span class="text-sm text-gray-500 mt-1">Attività Totali</span>
            </div>
            ...
            <div class="flex flex-col items-center text-center p-4 bg-blue-50 rounded-lg">
                ...
                <span class="text-sm text-gray-500 mt-1">Distanza (km)</span>
            </div>
            ...
            <div class="flex flex-col items-center text-center p-4 bg-green-50 rounded-lg">
                ...
                <span class="text-sm text-gray-500 mt-1">Dislivello (m)</span>
            </div>
            ...
            <div class="flex flex-col items-center text-center p-4 bg-purple-50 rounded-lg">
                ...
                <span class="text-sm text-gray-500 mt-1">Tempo Totale (h:mm)</span>
            </div>
            ...
            <div class="flex flex-col items-center text-center p-4 bg-yellow-50 rounded-lg">
                ...
                <span class="text-sm text-gray-500 mt-1">Tempo in Movimento (h:mm)</span>
            </div>
